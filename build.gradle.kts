...
kotlin {
    ...
    val xcf = XCFramework("RegexLite")

    macosArm64 {
        binaries.framework { baseName = "RegexLite"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RegexLite"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RegexLite"
        flattenPackage = "io.github.kotlinmania.regexlite"
    }

    android {
        namespace = "io.github.kotlinmania.regexlite"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "regex-lite-kotlin", version.toString())

    pom {
        name.set("regex-lite-kotlin")
        description.set("Kotlin Multiplatform port of rust-lang/regex - A lightweight regex engine that optimizes for binary size and compilation time")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/regex-lite-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/regex-lite-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/regex-lite-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/regex-lite-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.regexlite.codeql
