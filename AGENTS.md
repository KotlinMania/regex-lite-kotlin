...
This file is the quick-reference operating contract for regex-lite-kotlin. The longer
...
regex-lite-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`regex-lite`](https://crates.io/crates/regex-lite). Upstream Rust is the behavioral oracle while the
