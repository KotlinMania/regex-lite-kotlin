...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `RegexLite.swiftmodule/`
...
//      `import RegexLite` above would fail at compile time.
//
//   2. The static archive `libRegexLite.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "RegexLite" }` and
//      `flattenPackage = "io.github.kotlinmania.regexlite"` configuration in
...
//      via the `RegexLiteLibrary` product.
//
